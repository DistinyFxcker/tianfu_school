(function ($) {
  ...
  var ikSlider = function (el, options) {
    ...
    var $container = el;
    var $slider = $container.find('.slider_a');
    var $arrows = $('.slider__switch_a ');
    var $caption = $slider.find('.slider__caption_a');
    var $slide = $slider.find('.slider__item_a');
    ...
    function init() {
      ...
      if (settings.arrows) {
        ...
        !settings.infinite && _stopinfinite('prev_a');
    ...
    function _controls() {
      ...
      for (var i = 0; slideLen > i; i++) {
        ...
        links.push('<a class="slider-nav__control_a ' + act + '" data-ikslider-control="' + i + '"></a>');
      }
      $controlPanel.html(links.join(''));
      $navControl = $controlPanel.find('.slider-nav__control_a');
      $controlPanel.on('click.' + PLUGIN, '.slider-nav__control_a', function (e) {
        e.preventDefault();
    ...
    function show(slide) {
      ...
      if (!settings.infinite) {
        ...
        if (slide === slideLen - 1) {
          _stopinfinite('next_a');
        }

        if (current === 0) {
          _stopinfinite('prev_a');
        }
    ...
    function _stopinfinite(direction) {
      $('.slider__switch_a--' + direction).attr('disabled', true);
    }
